...
public class UnitItemBaseCtrl : MonoBehaviour
{
    ...
    public void DropItem(){
        ...
        //if(isOurTeam && this.gameObject.name == SceneController.instance.player.name){
        //    int randInt = Random.Range(0, SceneController.instance.Players_DropItems.Length);
        //    GameObject Instance = (GameObject)Instantiate(SceneController.instance.healthPack, currentPos, Quaternion.identity) as GameObject;
        //    GameObject dropInstance = (GameObject)Instantiate(SceneController.instance.Players_DropItems[randInt], new Vector3(currentPos.x - 2, currentPos.y, currentPos.z), Quaternion.identity) as GameObject;
        //}
        //else if(isOurTeam && this.gameObject.name != SceneController.instance.player.name){
        //    int randInt = Random.Range(0, SceneController.instance.Players_DropItems.Length);
        //    GameObject Instance = (GameObject)Instantiate(SceneController.instance.healthPack, currentPos, Quaternion.identity) as GameObject;
        //    GameObject dropInstance = (GameObject)Instantiate(SceneController.instance.Bot_DropItems, new Vector3(currentPos.x - 2, currentPos.y, currentPos.z), Quaternion.identity) as GameObject;
        //}
        //if(!isOurTeam){
        //    GameObject Instance = (GameObject)Instantiate(SceneController.instance.healthPack, currentPos, Quaternion.identity) as GameObject;
        //    GameObject dropInstance = (GameObject)Instantiate(SceneController.instance.Bot_DropItems, new Vector3(currentPos.x - 2, currentPos.y, currentPos.z), Quaternion.identity) as GameObject;
