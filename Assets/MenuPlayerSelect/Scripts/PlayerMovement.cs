...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        Debug.Log("Player Speed: " + GameManager.instance.playerSpeed);//New
        Debug.Log("Player Range: " + GameManager.instance.playerRange);//New
        Debug.Log("Player Cool: " + GameManager.instance.playerCool);//New
